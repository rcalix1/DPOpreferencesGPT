...
class ResidualSIHead(nn.Module):
    def __init__(self, input_dim, dropout_rate=0.8):
        super().__init__()
...
class Head(nn.Module):
    ...
    def __init__(self, head_size, n_embd, block_size, dropout_rate=0.8):
        super().__init__()
...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, num_heads, head_size, n_embd, block_size, dropout_rate=0.8):    ## (8, 64)
        super().__init__()
...
class FeedForward(nn.Module):
    ...
    def __init__(self, n_embd, dropout_rate=0.8):         ## 512
...
class Time_Series_GPT(nn.Module):
    ...
    def __init__(self, params_obj, dropout_rate=0.8):
